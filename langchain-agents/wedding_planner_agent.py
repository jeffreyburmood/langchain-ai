...
# first, set up the tools to be used by the supervisor agent
...
# next, set up the agent state and any context
...
# now we are ready for the main supervisor agent - the wedding coordinator
